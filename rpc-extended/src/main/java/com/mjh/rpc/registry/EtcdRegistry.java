...
public class EtcdRegistry implements Registry {
    ...
    private Set<String> localRegistryNodeKeySet;
    ...
    public void init(RegistryConfig registryConfig) {
        ...
        localRegistryNodeKeySet = new HashSet<>();
        heartBeat();
    ...
    public List<ServiceMetaInfo> serviceDiscovery(String serviceKey) {
        //TODO:现在是单服务模式，后续需要按照serviceKey进行区分缓存
        // 优先从缓存获取服务
    ...
    public void destroy() {
        ...
        for (String nodeKey : localRegistryNodeKeySet) {
            try {
                ...
                throw new RuntimeException(nodeKey + "结点下线失败", e);
            }
